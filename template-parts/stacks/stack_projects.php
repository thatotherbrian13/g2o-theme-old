...
echo "<div class='swiper swiper-projects w-full h-auto mx-auto'>";
					...
					echo "<div class='flex flex-col md:flex-row w-full'>";
						...
						echo "<div class='w-full h-full md:w-1/2 md:h-full md:order-first flex items-center'>";
							echo "<div class='pt-25 pb-40 w-4/5 mx-auto'>";
								...
								if ($heading) echo "<h3 class='font-sans text-3xl lg:text-4xl font-bold leading-[1.3] -tracking-[0.02em] text-limestone mb-6'>" . acf_esc_html( $heading ) . "</h3>";
...
*/
	...
	echo "<div class='swiper-buttons-projects-container w-full md:w-1/2 left-0 right-auto bottom-12 absolute z-50'>";
		echo "<div class='swiper-buttons-projects'>";
...
/*
	...
	echo "<div class='swiper swiper-projects w-full h-auto mx-auto'>";
		...
		echo "<div class='swiper-button-next swiper-button-next-projects'></div>";
		echo "<div class='swiper-button-prev swiper-button-prev-projects'></div>";
//		echo "<div class='swiper-pagination swiper-pagination-projects'></div>";
...
wp_add_inline_script( 'g2o-script', $swiper_projects, 'after' );
